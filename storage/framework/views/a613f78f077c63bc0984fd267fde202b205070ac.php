    ...
    <div class="col-md-12">
        <div class="card">
            <div class="body">
                ...
                <hr>
                <form method="POST" action="<?php echo e(route('member-create')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\california_gym\resources\views/newmember.blade.php ENDPATH**/ ?>