...
<div class="row">
    <div class="col-md-3">
        <a type="button" class="btn btn-primary waves-effect btn-block" href="{{ route('new-education') }}">
